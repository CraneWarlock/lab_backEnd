...
namespace WarehouseManager.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "WarehouseCargoes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CargoName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehouseCargoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WarehouseCargoes_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseCargoes_WarehouseId",
                table: "WarehouseCargoes",
                column: "WarehouseId");
